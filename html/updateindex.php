	...
	<div id="form_container">
		...
		<form id="form_670561" class="appnitro" method="post" action="guidecreator.php" enctype='multipart/form-data'>
			<div class="form_description">
				...
				<p>
Make your keyguide you desire here! Please note that this is very very early beta. Lots of things aren't working! If you are interested in playing around with this more take a look at <a href="https://github.com/willwade/KeyGuideMaker">the github project page</a> which provides a line command tool to make your own keyguide and a whole templating system that makes keyguide designs far simpler than messing around in illustrator. <br /><br />If you want to try creating just a basic grid of cells for laser cutting try using <a href="gridtemplater.html">the GridTemplater tool</a>. <br /><br />Credit for these tools go to
